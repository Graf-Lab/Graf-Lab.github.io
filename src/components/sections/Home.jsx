    ...
    >
      <div className="text-center z-10 px-4">
        ...
        <div className="flex justify-center space-x-4">
          ...
          <a
            href="contact"
            className="border border-blue-500 text-blue-500 py-3 px-6 rounded font-medium transition relative overflow-hidden hover:-traslate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)]"
          >
            Contact Me
          </a>
        </div>
